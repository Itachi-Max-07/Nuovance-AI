  ...
  return (
    <div className="w-full max-w-2xl px-1">
      <div className="ws-item">
        <div className="ws-glass overflow-hidden">
          <div className="flex items-center gap-2 border-b border-brand-line px-4 py-3 sm:px-5">
            <Database size={16} aria-hidden="true" className="text-brand-accent-2" />
              ...
              <span
                ...
                className={cn(
                  ...
                  destination === crm.activeDestination
                    ? "border-brand-accent/50 bg-brand-accent/10 text-brand-accent-2"
          ...
          <div className="px-4 py-3 sm:px-5">
            <div className="grid grid-cols-3 gap-2 border-b border-brand-line pb-2 text-2xs uppercase tracking-[0.14em] text-brand-muted sm:grid-cols-4">
            ...
            {qualified.map((company, index) => (
              <div
                key={company.name}
                className="ws-item grid grid-cols-3 gap-2 border-b border-brand-line py-2.5 text-xs text-brand-slate last:border-b-0 sm:grid-cols-4 sm:text-sm"
                style={{ animationDelay: `${250 + index * 170}ms` }}
              >
                <span className="truncate font-medium text-brand-offwhite">{company.name}</span>
      ...
      <div className="ws-item mt-4 flex justify-center" style={{ animationDelay: "500ms" }}>
        <div className="ws-glass flex items-baseline gap-2 px-5 py-3">
          <span className="font-heading text-2xl font-semibold tabular-nums text-brand-offwhite">
            {synced}
          </span>
