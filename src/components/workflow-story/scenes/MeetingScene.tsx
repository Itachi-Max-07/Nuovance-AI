    ...
    <div className="ws-item w-full max-w-md px-1">
      <div className="ws-card p-6 sm:p-8">
        <div className="flex flex-col items-center text-center">
          ...
          <h4 className="mt-4 text-xl font-semibold text-brand-ink sm:text-2xl">
            {meeting.title}
          </h4>
        </div>

        <ul className="mt-6 flex flex-col gap-3 border-t border-brand-line pt-5">
          <li className="flex items-center gap-3 text-xs text-brand-body sm:text-sm">
            <CalendarCheck size={16} aria-hidden="true" className="shrink-0 text-brand-accent-deep" />
            {meeting.event}
          </li>
          <li className="flex items-center gap-3 text-xs text-brand-body sm:text-sm">
            <Buildings size={16} aria-hidden="true" className="shrink-0 text-brand-accent-deep" />
            {meeting.company} · {meeting.attendee}
          </li>
          <li className="flex items-center gap-3 text-xs text-brand-body sm:text-sm">
            <ArrowUpRight size={16} aria-hidden="true" className="shrink-0 text-brand-accent-deep" />
            {meeting.opportunity}
          </li>
        </ul>
