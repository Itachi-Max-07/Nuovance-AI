  ...
  return (
    <div className="relative flex h-full w-full items-center justify-center">
      ...
      <div className="ws-item absolute right-0 top-0 sm:right-4 sm:top-2">
        <div className="ws-glass flex items-center gap-2 px-3 py-2">
          ...
          <span className="text-2xs font-medium uppercase tracking-[0.16em] text-brand-slate">
      ...
      <div className="ws-item absolute bottom-0 left-0 sm:bottom-2 sm:left-4" style={{ animationDelay: "250ms" }}>
        <div className="ws-glass px-5 py-4">
          <p className="font-heading text-3xl font-semibold tabular-nums text-brand-offwhite sm:text-4xl">
            {discovered}
          </p>
          <p className="mt-1 text-2xs uppercase tracking-[0.16em] text-brand-muted sm:text-xs">
            {scan.counterLabel}
          </p>
        </div>
      </div>
